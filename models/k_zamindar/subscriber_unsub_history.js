...
module.exports = (sequelize, DataTypes) => {
    class SubscriberUnsubHistory extends Model {
        /**
    ...
    SubscriberUnsubHistory.init({
        ...
        sequelize,
        modelName: 'SubscriberUnsubHistory',
        tableName: 'subscriber_unsub_history',
        timestamps: false
    });
    return SubscriberUnsubHistory;
};